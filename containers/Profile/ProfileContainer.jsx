...
const ProfilePageLayout = ({ data, query, profile, params }) => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row bg-grayBg w-full justify-between p-7 gap-7 z-0 pt-20 sm:pt-16 items-start">
        <div
          id="profile-sidebar-content"
          className=" bg-white w-full md:w-full lg:w-[40%] p-3 border shadow-lg rounded-3xl md:mb-7"
        >
          <ProfileCardInfo
            data={data}
            isHearted={isHearted}
